...
const ProductDetails = () => {
  ...
  // Function to fetch categories and subcategories for the modal
  const fetchCategoriesAndSubcategories = async () => {
    try {
      // Example API calls - replace with your actual endpoints
      const categoriesResponse = await axios.get('https://pos.idotsolution.com/api/Setting/categories');
      setCategories(categoriesResponse.data.data.map(cat => ({
        id: cat.categoryId,
        name: cat.category
      })));
      
      // For subcategories - replace with your actual endpoint
      const subcategoriesResponse = await axios.get('https://pos.idotsolution.com/api/Setting/subcategories');
      setSubcategories(subcategoriesResponse.data.data || []);
    } catch (error) {
      console.error('Error fetching categories/subcategories:', error);
      messageApi.error('Failed to load categories or subcategories');
    }
  };
  ...
  const handleFormSubmit = async (values) => {
    ...
    try {
      // Example API call to add a new product
      // const response = await axios.post('https://pos.idotsolution.com/api/Products/add', values);
      
      // Instead of actual API call, just display success message for now
